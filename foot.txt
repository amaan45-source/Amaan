...
<body id="top">
  ...
  <main>
    <article>
      ...
      <input type="hidden" name="name" value="Running Sneaker Shoes">
      <input type="hidden" name="price" value="180.85">
      <input type="hidden" name="image" value="./assets/images/product-1.jpg">
